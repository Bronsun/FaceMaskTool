...
bl_info = {
    "name": "FaceMaskTool - Seeleecon",
    "author": "Mateusz Broncel",
    "version": (0, 2, 1),
    "blender": (2, 92, 0),
    "location": "Viewport > Right panel",
    "description": "Custom made 3D printable breathing Mask, based on 3D scanned face",
    "warning": "",
    "wiki_url": "https://seeleecon.com/wiki",
    "tracker_url": "",
    "category": "Object",
}
...
translation_dict = {
    "it": {
        ...
        (
            "*",
            "Extract mask border based on red area",
        ): "Estrai il contorno dell'area rossa e adatta la maschera",
        ("*", "Invert border symmetry"): "Inverti la simmetria del bordo",
        ("*", "Symmetrize contact border"): "Rendi simmetrico il bordo di contatto",
        (
            "*",
            "Automatically remesh surface",
        ): "Ricostruisci automaticamente la superficie chiudendo eventuali fori",
        (
            "*",
            "Manually edit control points",
        ): "Modifica manuale dei punti di controllo",
        (
            "*",
            "You are going to do a destructive operation",
        ...
        (
            "*",
            "Define the area on the face using the brush tool",
        ): "Definisci l'area sul volto utilizzando il pennello",
        ...
        (
            "*",
            "Manually align position and rotation of the filter",
        ): "Allinea manualmente la posiizione e la rotazione del filtro",
        (
            "*",
            "Identification code to manually emboss on the surface",
        ): "Codice identificativo da inserire in rilievo sulla superficie",
        (
            "*",
            "You are creating a new scene, all the unsaved work will be lost!",
        ): "Stai per creare una nuova scena, tutto il lavoro non salvato verrà perso!",
        (
            "*",
            "Setup a new scene for MyFaceMask",
        ): "Imposta una nuova scena per MyFaceMask",
    ...
    "es": {
        ...
        (
            "*",
            "Extract mask border based on red area",
        ): "Extraer el contorno del área roja y adaptar la màscara",
        ("*", "Invert border symmetry"): "Invertir la simetría del borde",
        (
            "*",
            "Symmetrize contact border",
        ): "Hacer que el borde de contacto sea simétrico",
        (
            "*",
            "Automatically remesh surface",
        ): "Reconstruir automáticamente la superficie cerrando cualquier hoyo",
        (
            "*",
            "Manually edit control points",
        ): "Modificar manualmente puntos de control",
        (
            "*",
            "You are going to do a destructive operation",
        ): "Atención, estas haciendo una operación destructiva",
        ("*", "Press ESC to undo"): "Presiona la tecla ESCAPE para deshacer",
        ("*", "End manual editing"): "Terminar modificación manual",
        (
            "*",
            "End manual tag insertion",
        ): "Terminar inserción de identificación manual",
        (
            "*",
            "Define the area on the face using the brush tool",
        ): "Definir el área del rostro mediante el pincel",
        ...
        (
            "*",
            "Manually align position and rotation of the filter",
        ): "Alinear manualmente la posición y la rotación del filtro",
        (
            "*",
            "Identification code to manually emboss on the surface",
        ): "Añadir código de identificación en relieve en el área",
        (
            "*",
            "You are creating a new scene, all the unsaved work will be lost!",
        ): "¡Estas creando una nueva escena, todo el trabajo que no está guardado sera perdido!",
        (
            "*",
            "Setup a new scene for MyFaceMask",
        ): "Configurar una nueva escena para MyFaceMask",
    ...
    "pl": {
        ("Operator", "Adapt mask"): "Dostosuj maskę",
        ("Operator", "Remesh"): "Przebuduj siatkę",
        ("*", "Change brush mode"): "Zmień tryb pędzla",
        ("*", "Manually add ID tag"): "Ręcznie dodaj tag ID",
        (
            "*",
            "Extract mask border based on red area",
        ): "Wyodrębnij granicę maski na podstawie czerwonego obszaru",
        ("*", "Invert border symmetry"): "Odwróć symetrię granicy",
        ("*", "Symmetrize contact border"): "Zsymetryzuj granicę kontaktu",
        (
            "*",
            "Automatically remesh surface",
        ): "Automatycznie przebuduj powierzchnię, zamykając ewentualne otwory",
        ("*", "Manually edit control points"): "Ręcznie edytuj punkty kontrolne",
        (
            "*",
            "You are going to do a destructive operation",
        ): "Uwaga, zamierzasz przeprowadzić operację destrukcyjną",
        ("*", "Press ESC to undo"): "Naciśnij ESC, aby cofnąć",
        ("*", "End manual editing"): "Zakończ ręczną edycję",
        ("*", "End manual tag insertion"): "Zakończ ręczne wprowadzanie tagów",
        (
            "*",
            "Define the area on the face using the brush tool",
        ): "Zdefiniuj obszar na twarzy, używając narzędzia pędzla",
        ("*", "Prepare model for 3D printing"): "Przygotuj model do druku 3D",
        ("*", "Prepare 3D print:"): "Przygotuj do druku 3D:",
        ("*", "Manually place holes"): "Ręcznie umieść otwory",
        (
            "*",
            "Manually align position and rotation of the filter",
        ): "Ręcznie wyrównaj pozycję i rotację filtra",
        (
            "*",
            "Identification code to manually emboss on the surface",
        ): "Kod identyfikacyjny do ręcznego wytłoczenia na powierzchni",
        (
            "*",
            "You are creating a new scene, all the unsaved work will be lost!",
        ): "Tworzysz nową scenę, wszystkie niezapisane prace zostaną utracone!",
        ("*", "Setup a new scene for MyFaceMask"): "Ustaw nową scenę dla MyFaceMask",
        ("Operator", "Prepare model"): "Przygotuj model",
        ("Operator", "Invert symmetry"): "Odwróć symetrię",
        ("Operator", "Define area"): "Zdefiniuj obszar",
        ("Operator", "Symmetric border on"): "Włącz symetryczną granicę",
        ("Operator", "Symmetric border off"): "Wyłącz symetryczną granicę",
        ("Operator", "Align filter"): "Wyrównaj filtr",
        ("Operator", "Manual editing"): "Ręczna edycja",
        ("Operator", "Setup scene"): "Ustaw scenę",
        ("Operator", "Done"): "Gotowe",
        ("Operator", "End editing"): "Zakończ edycję",
        ("*", "Nose pressure"): "Ciśnienie na nos",
        ("*", "Import scan:"): "Importuj skan:",
        ("*", "Adapt mask:"): "Dostosuj maskę:",
        ("*", "Adjust:"): "Dostosuj:",
        ("*", "Identity:"): "Tożsamość:",
        ("*", "Export:"): "Eksport:",
        ("Operator", "Insert tag"): "Wstaw tag",
        ("Operator", "Show holes"): "Pokaż otwory",
        ("Operator", "Align filter on"): "Włącz wyrównywanie filtra",
        ("Operator", "Align filter off"): "Wyłącz wyrównywanie filtra",
        ("Operator", "Hide holes"): "Ukryj otwory",
        ("Operator", "Prepare model"): "Przygotuj model",
        ("Operator", "Place holes"): "Umieść otwory",
    },
}
